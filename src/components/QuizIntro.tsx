...
const QuizIntro: React.FC<QuizIntroProps> = ({ onStart }) => {
  ...
  const logoUrl =
    introConfig?.logoUrl || globalConfig?.logoUrl || DEFAULT_LOGO_URL;
