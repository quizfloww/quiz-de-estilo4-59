...
export const PersonalizedHook: React.FC<PersonalizedHookProps> = ({
  ...
  return (
    <div className="text-center p-0">
      ...
      <div className="flex flex-col items-center justify-center gap-5 sm:gap-6 mb-6">
        {" "}
        {/* Aumentado gap para 5/6, e mb para 6 */}
      ...
      <p className="text-[#ff6b6b] text-xs font-medium mt-4 sm:mt-6">
        {" "}
        {/* Alterado de text-sm para text-xs */}⚡ Esta oferta expira quando
