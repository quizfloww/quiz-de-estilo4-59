...
export const QuizOfferHero: React.FC<QuizOfferHeroProps> = ({
  onStartQuizClick,
}) => {
    ...
    <div className="bg-[#F9F7F4] py-8 px-4 md:py-16 md:px-8 rounded-lg">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-[#432818]/80 mb-6 max-w-3xl mx-auto">
          Um teste exclusivo que revela seu estilo autêntico e como expressar
          sua verdadeira essência através das roupas que você escolhe.
        </p>
