...
const DEFAULT_FAQ: FaqItem[] = [
  { 
    ...
    answer: 'O Guia é um material digital personalizado baseado no resultado do seu quiz. Você receberá dicas de roupas, cores e acessórios que combinam com seu estilo predominante.'
  },
  { 
    id: '2', 
    question: 'Quanto tempo tenho acesso ao material?',
    answer: 'O acesso é vitalício! Você pode consultar o guia sempre que precisar, sem prazo de expiração.'
  },
  { 
    id: '3', 
    question: 'E se eu não gostar do conteúdo?',
    answer: 'Oferecemos garantia de 7 dias. Se não ficar satisfeita, devolvemos 100% do valor investido.'
  },
  { 
    id: '4', 
    question: 'Como recebo o material?',
    answer: 'Após a confirmação do pagamento, você receberá um e-mail com o link de acesso à área de membros.'
  },
];
  ...
  if (style === 'list') {
    return (
      <div className="w-full space-y-4">
        ...
        {faqItems.map((item) => (
          <div key={item.id} className="p-4 bg-white rounded-lg border border-[#B89B7A]/20">
            <h4 className="font-semibold text-[#432818] mb-2">{item.question}</h4>
