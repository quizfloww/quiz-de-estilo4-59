...
export const SocialProofBlock: React.FC<SocialProofBlockProps> = ({ content, isPreview }) => {
  const text = content.socialProofText || '+3.000 mulheres já descobriram seu estilo';
  ...
  if (variant === 'banner') {
    return (
      <div className="w-full py-3 px-4 bg-gradient-to-r from-[#B89B7A]/10 to-[#D4AF37]/10 border-y border-[#B89B7A]/20">
