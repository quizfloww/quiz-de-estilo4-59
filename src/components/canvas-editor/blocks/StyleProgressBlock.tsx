...
export const StyleProgressBlock: React.FC<StyleProgressBlockProps> = ({ content, isPreview }) => {
  ...
  return (
    <div className="w-full p-6 rounded-xl bg-white border border-[#B89B7A]/20">
