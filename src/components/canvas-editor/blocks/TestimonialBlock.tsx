...
export const TestimonialBlock: React.FC<TestimonialBlockProps> = ({ content, isPreview }) => {
  ...
  if (variant === 'minimal') {
    return (
      <div className="w-full p-4">
        <p className="text-[#5A4A3A] italic text-center mb-3">"{testimonial.text}"</p>
  ...
  if (variant === 'quote') {
    return (
      <div className="w-full p-6 relative">
        ...
        <div className="pl-8">
          <p className="text-lg text-[#5A4A3A] italic mb-4">"{testimonial.text}"</p>
  ...
  return (
    <div className="w-full p-6 bg-white rounded-xl border border-[#B89B7A]/20 shadow-sm">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            ...
            {testimonial.role && (
              <span className="text-sm text-[#8F7A6A]">• {testimonial.role}</span>
            )}
          </div>
          {testimonial.rating && (
