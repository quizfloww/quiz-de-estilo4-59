...
export const BlockRenderer: React.FC<BlockRendererProps> = ({
  ...
  const renderBaseBlock = () => {
    switch (block.type) {
      ...
      case "styleResult":
        return (
          <StyleResultBlock content={block.content} isPreview={isPreview} />
        );
      ...
      case "styleGuide":
        return (
          <StyleGuideBlock content={block.content} isPreview={isPreview} />
        );
      case "beforeAfter":
        return (
          <BeforeAfterBlock content={block.content} isPreview={isPreview} />
        );
      // Blocos de Oferta/Vendas
      case "priceAnchor":
        return (
          <PriceAnchorBlock content={block.content} isPreview={isPreview} />
        );
      case "countdown":
        return <CountdownBlock content={block.content} isPreview={isPreview} />;
      case "testimonial":
        return (
          <TestimonialBlock content={block.content} isPreview={isPreview} />
        );
      case "testimonials":
        return (
      ...
      case "socialProof":
        return (
          <SocialProofBlock content={block.content} isPreview={isPreview} />
        );
      case "motivation":
        return (
          <MotivationBlock content={block.content} isPreview={isPreview} />
        );
      case "bonus":
  ...
  // Envolver com EnhancedBlockRenderer se não for modo de edição
  if (!isEditing && !isPreview) {
    return (
      <EnhancedBlockRenderer block={block} isPreview={isPreview}>
        {renderBaseBlock()}
      </EnhancedBlockRenderer>
    );
  }

  // No modo de edição ou preview, renderizar diretamente
