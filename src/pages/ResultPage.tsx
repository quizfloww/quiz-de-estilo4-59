...
// Type para window com analytics
...
const ResultPage: React.FC = () => {
  ...
  const handleCTAClick = () => {
    const win = window as WindowWithAnalytics;
    if (typeof window !== "undefined" && win.gtag) {
      win.gtag("event", "checkout_initiated", {
        test_name: "urgency_countdown_position",
        variant: testVariant,
  ...
  const StyleGuidesVisual: React.FC<StyleGuidesVisualProps> = ({
    ...
    const secondaryGuideImages = secondaryStyles
      ...
      .map((style) => ({
        src: `${
          styleConfig[style.category].guideImage
        }?q=auto:best&f=auto&w=80`, // Miniatura de 80px
    ...
    return (
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 mt-8 max-w-[600px] mx-auto relative">
        ...
        <img
          ...
          width="540"
          height="auto" // Mantém o width/height para acessibilidade
        />
      ...
      <div className="container mx-auto px-4 py-6 max-w-4xl relative z-10">
        ...
        */}
        ...
        <AnimatedWrapper
          ...
          duration={400}
          delay={1100}
          className="mt-8 mb-12 md:mt-10 md:mb-16"
        >
          <div className="text-center">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-[#B89B7A]/20 card-elegant mb-8 max-w-md mx-auto">
              ...
              <div className="text-center p-4 bg-gradient-to-r from-[#4CAF50]/10 to-[#45a049]/10 rounded-lg border border-[#4CAF50]/30">
                <p className="text-sm text-[#4CAF50] uppercase font-medium">
                  Especial para {category}: -78% HOJE
                </p>
                ...
                <div className="mt-2 bg-[#ff6b6b]/10 rounded-full px-3 py-1 inline-block">
                  <p className="text-xs text-[#ff6b6b] font-medium">
                    💥 Preço volta para R$ 175 em breve
                  </p>
                </div>
              </div>
            </div>
            ...
            <Button
              onClick={handleCTAClick}
              className="text-white py-6 px-3 sm:px-8 md:px-10 rounded-lg shadow-lg transition-all duration-300 transform-none sm:transform hover:scale-105 active:scale-95 sm:shadow-lg sm:hover:shadow-xl min-w-0"
              style={{
            ...
            >
              ...
              >
                ...
                <ShoppingCart
                  className={`hidden sm:block w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-300 ${
                    isButtonHovered ? "scale-120" : ""
                  }`}
                />
            ...
            <p className="text-sm text-[#aa6b5d] mt-2 flex items-center justify-center gap-1">
              ...
              <span>
                Oferta exclusiva para {category} - Apenas nesta página
              </span>
            </p>
          </div>
        </AnimatedWrapper>
